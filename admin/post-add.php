            ...
            <form id="postData" class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input id="btn-addPost" class="btn btn-primary" type="button" value="保存">
                    </div>
                </div>
            </form>
        </div>
        ...
        $(function () {
            ...
            $('#feature').on('change',function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        console.log(res);
                        if(res.code==1){
                            newfile = '/static/uploads/'+res.file;
                            $('.thumbnail').show().attr('src',newfile);
                        }
                    }
                });
            }); 
            ...
            $("#btn-addPost").on('click',function () {  
                ...
                $.ajax({
                    ...
                    data: ($('#postData').serialize()) + '&feature=' + newfile,
                    success: function (res) {
                       if(res.code==1){
                           alert('保存成功');
                       }
