...
! function(e, t) { var n = t.jQuery; "object" == typeof exports ? module.exports = n ? e(t, n) : function(n) { if (n && !n.fn) throw "Provide jQuery or null"; return e(t, n) } : "function" == typeof define && define.amd ? define(function() { return e(t) }) : e(t, !1) }(function(e, t) {
    "use strict";
    ...
    function r(e, t) { return ne(t) && (t = n(e ? e._d ? e : n(a, e) : a, t), t._d = 1), t }

    function i(e, t) { for (var n in t.props) !Ee.test(n) || e[n] && e[n].fix || (e[n] = r(e.constructor.prototype[n], t.props[n])) }
    ...
    function d(e) { this.name = (t.link ? "JsViews" : "JsRender") + " Error", this.message = e || this.name }

    function l(e, t) { for (var n in t) e[n] = t[n]; return e }

    function u(e, t, n) { return e ? re(e) ? u.apply(ee, e) : (le.delimiters = [e, t, he = n ? n.charAt(0) : he], pe = e.charAt(0), fe = e.charAt(1), ge = t.charAt(0), ve = t.charAt(1), e = "\\" + pe + "(\\" + he + ")?\\" + fe, t = "\\" + ge + "\\" + ve, X = "(?:(\\w+(?=[\\/\\s\\" + ge + "]))|(\\w+)?(:)|(>)|(\\*))\\s*((?:[^\\" + ge + "]|\\" + ge + "(?!\\" + ve + "))*?)", de.rTag = "(?:" + X + ")", X = new RegExp("(?:" + e + X + "(\\/)?|\\" + pe + "(\\" + he + ")?\\" + fe + "(?:(?:\\/(\\w+))\\s*|!--[\\s\\S]*?--))" + t, "g"), de.rTmpl = new RegExp("^\\s|\\s$|<.*>|([^\\\\]|^)[{}]|" + e + ".*" + t), ce) : le.delimiters }
    ...
    function p() { var e = this.get("item"); return e ? e.index : void 0 }
    ...
    function g(t, n, r) {
        var i, o, a, s, d = this,
            u = !we && void 0 !== n,
            c = d.ctx;
        if (t in c || t in (c = ae)) { if (a = c && c[t], a && ne(a)) return i = function() { return a.apply(this && this !== e ? this : d, arguments) }, l(i, a), i._vw = d, i; if ("tag" === t || "root" === t || "parentTags" === t || d._.it === t) return a } else c = void 0;
    ...
    function w(e, t) { return e = e[+t === t ? "args" : "props"], e && e[t] }

    function x(e) { return this.cvtArgs(void 0, !0, e) }

    function _(e, t) { for (var n, r, i = this; void 0 === n && i;) r = i.tmpl && i.tmpl[e], n = r && r[t], i = i.parent; return n || ee[e][t] }
        ...
        if (!(s._er = a)) {
            for (i(s, r[0]), s.rendering = {}, E = 0; E < f; E++) {
                if (h = s.tagCtx = r[E], T = h.props, s.ctx = h.ctx, E || (y && (A = s.template, s.init(h, N, s.ctx), y = void 0), N && (N.attr = s.attr = N.attr || s.attr), c = s.attr, s._.noVws = c && c !== Pe), j = s.cvtArgs(void 0, void 0, E), s.linkedCtxParam)
                    for (g = _.length; g--;)(x = s.linkedCtxParam[g]) && ($ = _[g], h.ctx[x] = de._cp(w(h, $), w(h.params, $), h.view, s._.bnd && { tag: s, ind: g, tagElse: E }));
                (k = T.dataMap || V) && (j.length || T.dataMap) && (C = h.map, C && C.src === j[0] && !o || (C && C.src && C.unmap(), C = h.map = k.map(j[0], T, void 0, !s._.bnd)), j = [C.tgt]), v = void 0, s.render && (v = s.render.apply(s, j), t.linked && v && !Me.test(v) && (v = F({ fn: function() { return v }, links: [] }, t.data, void 0, !0, t, void 0, void 0, s))), j.length || (j = [t]), void 0 === v && (R = j[0], s.contentCtx && (R = s.contentCtx === !0 ? t : s.contentCtx(R)), v = h.render(R, !0) || (o ? void 0 : "")), M = M ? M + (v || "") : v
            }
            s.rendering = void 0
        }
        return s.tagCtx = r[0], s.ctx = s.tagCtx.ctx, s._.noVws && s._.inline && (M = "text" === c ? oe.php(M) : ""), U && t._.onRender ? t._.onRender(M, t, s) : M
    }

    function y(e, t, n, r, i, o, a, s) {
        var d, l, u, c = this,
            f = "array" === t;
        c.content = s, c.views = f ? [] : {}, c.parent = n, c.type = t || "top", c.root = n && n.root || t && c, c.data = r, c.tmpl = i, u = c._ = { key: 0, useKey: f ? 0 : 1, id: "" + Se++, onRender: a, bnds: {} }, c.linked = !!a, n ? (d = n.views, l = n._, l.useKey ? (d[u.key = "_" + l.useKey++] = c, c.index = qe, c.getIndex = p) : d.length === (u.key = c.index = o) ? d.push(c) : d.splice(o, 0, c), c.ctx = e || n.ctx) : c.ctx = e || {}
    }

    function k(e) { var t, n, r; for (t in Le) n = t + "s", e[n] && (r = e[n], e[n] = {}, ee[n](r, e)) }
    ...
    function C(e, t, n) {
        ...
        var a, s, d, u, c, p, f = t.bindTo,
            g = new de._tg;
        if (ne(t) ? t = { depends: t.depends, render: t } : "" + t === t && (t = { template: t }), void 0 !== f)
            for (f = t.bindTo = re(f) ? f : [f], u = p = f.length; u--;) c = f[u], isNaN(parseInt(c)) || (c = parseInt(c)), f[u] = c;
        if (o("linkedElement"), o("linkedCtxParam"), s = t.baseTag) { t.flow = !!t.flow, t.baseTag = s = "" + s === s ? n && n.tags[s] || se[s] : s, g = l(g, s); for (d in t) g[d] = r(s[d], t[d]) } else g = l(g, t);
        return void 0 !== (a = g.template) && (g.template = "" + a === a ? ie[a] || ie(a) : a), (i.prototype = g).constructor = g._ctr = i, n && (g._parentTmpl = n), g
    }

    function j(e) { return this.base.apply(this, e) }
    ...
    function T(e, n, r, i) {
        function o(n) {
            ...
            if ("" + n === n || n.nodeType > 0 && (a = n)) {
                if (!a)
                    ...
                    else if (t.fn && !de.rTmpl.test(n)) try { a = t(n, document)[0] } catch (d) {}
        ...
        var a, s, d = n = n || "";
        if (0 === i && (i = void 0, d = o(d)), i = i || (n.markup ? n : {}), i.tmplName = e, r && (i._parentTmpl = r), !d && n.markup && (d = o(n.markup)) && d.fn && (d = d.markup), void 0 !== d) return d.fn || n.fn ? d.fn && (s = d) : (n = $(d, i), U(d.replace(je, "\\$&"), n)), s || (s = l(function() { return s.render.apply(s, arguments) }, n), k(s)), s
    }

    function A(e, t) { return ne(e) ? e.call(t) : e }

    function V(e) { for (var t = [], n = 0, r = e.length; n < r; n++) t.push(e[n].unmap()); return t }

    function R(e, n) {
        function r(e) { u.apply(this, e) }

        function i() { return new r(arguments) }

        function o(e, t) { for (var n, r, i, o, a = 0; a < w; a++) i = p[a], n = void 0, i + "" !== i && (n = i, i = n.getter), void 0 === (o = e[i]) && n && void 0 !== (r = n.defaultVal) && (o = A(r, e)), t(o, n && c[n.type], i) }
        ...
        function a(t) {
            ...
            var n, r, i = 0,
                a = t,
                l = [];
            if (re(t)) { for (t = t || [], n = t.length; i < n; i++) l.push(this.map(t[i])); return l._is = e, l.unmap = d, l.merge = s, l }
            if (t) { o(t, function(e, t) { t && (e = t.map(e)), l.push(e) }), a = this.apply(this, l); for (r in t) r === te || _[r] || (a[r] = t[r]) }
            return a
        }
        ...
        function s(e) {
            ...
            o(e, function(e, t, n) { t ? f[n]().merge(e) : f[n](e) });
        ...
        var l, u, c = this,
            ...
            f = n.extend,
            g = n.id,
            v = t.extend({ _is: e || "unnamed", unmap: d, merge: s }, f),
            h = "",
            m = "",
            w = p ? p.length : 0,
            x = t.observable,
        ...
        for (r.prototype = v, l = 0; l < w; l++) ! function(e) {
            ...
            var t = "_" + e;
            h += (h ? "," : "") + e, m += "this." + t + " = " + e + ";\n", v[e] = v[e] || function(n) { return arguments.length ? void(x ? x(this).setProperty(e, n) : this[t] = n) : this[t] }, x && (v[e].set = v[e].set || function(e) { this[t] = e })
        }(p[l]);
    ...
    function $(e, n) {
        var r, i = ue._wm || {},
            o = l({ tmpls: [], links: {}, bnds: [], _is: "template", render: S }, n);
        return o.markup = e, n.phpTag || (r = Ve.exec(e), o.phpTag = r ? r[1].toLowerCase() : ""), r = i[o.phpTag], r && r !== i.div && (o.markup = t.trim(o.markup)), o
    }

    function E(e, t) {
        function n(i, o, a) { var s, d, l, u = de.onStore[e]; if (i && typeof i === Ie && !i.nodeType && !i.markup && !i.getTgt && !("viewModel" === e && i.getters || i.extend)) { for (d in i) n(d, i[d], o); return o || ee } return void 0 === o && (o = i, i = void 0), i && "" + i !== i && (a = o, o = i, i = void 0), l = a ? "viewModel" === e ? a : a[r] = a[r] || {} : n, s = t.compile, null === o ? i && delete l[i] : (s && (o = s.call(l, i, o, a, 0), o._is = e), i && (l[i] = o)), u && u(i, o, a, s), o }
        var r = e + "s";
        ee[r] = n
    }

    function M(e) { ce[e] = function(t) { return arguments.length ? (le[e] = t, ce) : le[e] } }

    function N(e) {
        function t(t, n) { this.tgt = e.getTgt(t, n) }
        return ne(e) && (e = { getTgt: e }), e.baseMap && (e = l(l({}, e.baseMap), e)), e.map = function(e, n) { return new t(e, n) }, e
    }
    ...
    function P(e, t, n) { var r = void 0 !== n ? ne(n) ? n.call(t.data, e, t) : n || "" : "{Error: " + (e.message || e) + "}"; return le.onError && void 0 !== (n = le.onError.call(t.data, e, n && r, t)) && (r = n), t && !t.linkCtx ? oe.php(r) : r }

    function I(e) { throw new de.Err(e) }

    function O(e) { I("Syntax error\n" + e) }

    function U(e, t, n, r, i) {
        function o(t) { t -= v, t && m.push(e.substr(v, t).replace(ke, "\\n")) }
        ...
        function s(s, d, l, p, g, x, _, b, y, k, C, j) {
            ...
            l = l || (b = b || "#data", g), o(j), v = j + s.length, _ ? f && m.push(["*", "\n" + b.replace(/^:/, "ret+= ").replace(Ce, "$1") + ";\n"]) : l ? ("else" === l && (Ae.test(b) && O('for "{{else if expr}}" use "{{else expr}}"'), A = w[8] && [
                []
            ], w[9] = e.substring(w[9], j), w = h.pop(), m = w[2], P = !0), b && B(b.replace(ke, " "), A, t).replace(Te, function(e, t, n, r, i, o, a, s) { return r = "'" + i + "':", a ? (R += o + ",", E += "'" + s + "',") : n ? ($ += r + "j._cp(" + o + ',"' + s + '",view),', N += r + "'" + s + "',") : t ? S += o : ("trigger" === i && (F += o), "lateRender" === i && (T = 1), V += r + o + ",", M += r + "'" + s + "',", c = c || Ee.test(i)), "" }).slice(0, -1), A && A[0] && A.pop(), u = [l, p || !!r || c || "", P && [], J(E || (":" === l ? "'#data'," : ""), M, N), J(R || (":" === l ? "data," : ""), V, $), S, F, T, A || 0], m.push(u), P && (h.push(w), w = u, w[9] = v)) : C && (a(C !== w[0] && "else" !== w[0] && C, w[0]), w[9] = e.substring(w[9], j), w = h.pop()), a(!w && C), m = w[2]
        }
    ...
    function q(e, t) {
        var n, r, i = 0,
            o = t.length;
        for (e.deps = [], e.paths = []; i < o; i++) { e.paths.push(r = t[i]); for (n in r) "_jsvto" !== n && r.hasOwnProperty(n) && r[n].length && !r[n].skp && (e.deps = e.deps.concat(r[n])) }
    }

    function J(e, t, n) { return [e.slice(0, -1), t.slice(0, -1), n.slice(0, -1)] }
    ...
    function B(e, t, n) {
        function r(r, m, w, x, _, b, y, k, C, j, T, A, V, R, $, E, M, N, S, F) {
            ...
            if ("[" === j && (j = "[j._sq(", L = ")]"), !y || d || s) {
                ...
                return d ? (d = !V, d ? r : A + '"') : s ? (s = !R, s ? r : A + '"') : (w ? (h[g] = S++, u = c[++g] = { bd: [] }, w) : "") + (N ? g ? "" : (p = F.slice(p, S), (i ? (i = a = o = !1, "\b") : "\b,") + p + (p = S + r.length, l && t.push(u.bd = []), "\b")) : k ? (g && O(e), l && t.pop(), i = _, a = x, p = S + r.length, l && (l = u.bd = t[i] = [], l.skp = !x), _ + ":") : _ ? _.split("^").join(".").replace(be, P) + (j ? (u = c[++g] = { bd: [] }, v[g] = L, j) : b) : b ? b : $ ? ($ = v[g] || $, v[g] = !1, u = c[--g], $ + (j ? (u = c[++g], v[g] = L, j) : "")) : T ? (v[g] || O(e), ",") : m ? "" : (d = V, s = R, '"'))
            }
            O(e)
        }
    ...
    function Q(e, t) { return e && e !== t ? t ? l(l({}, t), e) : e : t && l({}, t) }

    function H(e) { return Fe[e] || (Fe[e] = "&#" + e.charCodeAt(0) + ";") }

    function D(e) {
        var t, n, r = [];
        if (typeof e === Ie)
            for (t in e) n = e[t], t !== te && e.hasOwnProperty(t) && !ne(n) && r.push({ key: t, prop: n });
        return r
    }
    ...
    function z(e) { return void 0 != e ? $e.test(e) && ("" + e).replace(Ne, H) || e : "" }
    var G = t === !1;
    t = t && t.fn ? t : e.jQuery;
    var W, X, Y, ee, te, ne, re, ie, oe, ae, se, de, le, ue, ce, pe, fe, ge, ve, he, me, we, xe = "v0.9.86",
        ...
        Ke = e.jsrender,
        Be = Ke && t && !t.render,
        Le = { template: { compile: T }, tag: { compile: C }, viewModel: { compile: R }, helper: {}, converter: {} };
    if (ee = { jsviews: xe, sub: { View: y, Err: d, tmplFn: U, parse: B, extend: l, extendCtx: Q, syntaxErr: O, onStore: { template: function(e, t) { null === t ? delete Je[e] : Je[e] = t } }, addSetting: M, settings: { allowCode: !1 }, advSet: a, _ths: i, _gm: r, _tg: function() {}, _cnvt: h, _tag: b, _er: I, _err: P, _html: z, _cp: o, _sq: function(e) { return "constructor" === e && O(""), e } }, settings: { delimiters: u, advanced: function(e) { return e ? (l(ue, e), de.advSet(), ce) : ue } }, map: N }, (d.prototype = new Error).constructor = d, p.depends = function() { return [this.get("item"), "index"] }, f.depends = "index", y.prototype = { get: c, getIndex: f, getRsc: _, getTmpl: v, ctxPrm: g, _is: "view" }, de = ee.sub, ce = ee.settings, !(Ke || t && t.render)) {
        for (W in Le) E(W, Le[W]);
        oe = ee.converters, ae = ee.helpers, se = ee.tags, de._tg.prototype = { baseApply: j, cvtArgs: m, bndArgs: x, ctxPrm: g }, Y = de.topView = new y, t ? (t.fn.render = Z, te = t.expando, t.observable && (l(de, t.views.sub), ee.map = t.views.map)) : (t = {}, G && (e.jsrender = t), t.renderFile = t.__express = t.compile = function() { throw "Node.js: use npm jsrender, or jsrender-node.js" }, t.isFunction = function(e) { return "function" == typeof e }, t.isArray = Array.isArray || function(e) { return "[object Array]" === {}.toString.call(e) }, de._jq = function(e) { e !== t && (l(e, t), t = e, t.fn.render = Z, delete t.jsrender, te = t.expando) }, t.jsrender = xe), le = de.settings, le.allowCode = !1, ne = t.isFunction, t.render = Je, t.views = ee, t.templates = ie = ee.templates;
        for (me in le) M(me);
        (ce.debugMode = function(e) { return void 0 === e ? le.debugMode : (le.debugMode = e, le.onError = e + "" === e ? new Function("", "return '" + e + "';") : ne(e) ? e : void 0, ce) })(!1), ue = le.advanced = { useViews: !1, _jsv: !1 }, se({
            "if": {
                render: function(e) {
                    var t = this,
                        n = t.tagCtx,
            ...
            ":*": { render: o, flow: !0 },
            dbg: ae.dbg = oe.dbg = s
        }), oe({ html: z, attr: z, url: function(e) { return void 0 != e ? encodeURI("" + e) : null === e ? e : "" } })
    }
